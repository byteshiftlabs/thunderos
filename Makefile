...
ifeq ($(ENABLE_TESTS),1)
    KERNEL_C_SOURCES += tests/unit/test_memory_mgmt.c \
						...
						tests/unit/test_syscall_errno.c \
...
force_fs: userland
	...
	@cp external/userland/build/cat $(BUILD_DIR)/testfs/bin/cat 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) cat not built"
	@cp external/userland/build/ls $(BUILD_DIR)/testfs/bin/ls 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) ls not built"
	@cp external/userland/build/hello $(BUILD_DIR)/testfs/bin/hello 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) hello not built"
	@cp external/userland/build/clock $(BUILD_DIR)/testfs/bin/clock 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) clock not built"
	@cp external/userland/build/mkdir $(BUILD_DIR)/testfs/bin/mkdir 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) mkdir not built"
	@cp external/userland/build/rmdir $(BUILD_DIR)/testfs/bin/rmdir 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) rmdir not built"
	@cp external/userland/build/pwd $(BUILD_DIR)/testfs/bin/pwd 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) pwd not built"
	@cp external/userland/build/touch $(BUILD_DIR)/testfs/bin/touch 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) touch not built"
	@cp external/userland/build/rm $(BUILD_DIR)/testfs/bin/rm 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) rm not built"
	@cp external/userland/build/clear $(BUILD_DIR)/testfs/bin/clear 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) clear not built"
	@cp external/userland/build/sleep $(BUILD_DIR)/testfs/bin/sleep 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) sleep not built"
	@cp external/userland/build/chmod $(BUILD_DIR)/testfs/bin/chmod 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) chmod not built"
	@cp external/userland/build/chown $(BUILD_DIR)/testfs/bin/chown 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) chown not built"
	@cp external/userland/build/ush $(BUILD_DIR)/testfs/bin/ush 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) ush not built"
	@cp external/userland/build/ps $(BUILD_DIR)/testfs/bin/ps 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) ps not built"
	@cp external/userland/build/uname $(BUILD_DIR)/testfs/bin/uname 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) uname not built"
	@cp external/userland/build/uptime $(BUILD_DIR)/testfs/bin/uptime 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) uptime not built"
	@cp external/userland/build/whoami $(BUILD_DIR)/testfs/bin/whoami 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) whoami not built"
	@cp external/userland/build/tty $(BUILD_DIR)/testfs/bin/tty 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) tty not built"
	@cp external/userland/build/kill $(BUILD_DIR)/testfs/bin/kill 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) kill not built"
	@cp external/userland/build/poweroff $(BUILD_DIR)/testfs/bin/poweroff 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) poweroff not built"
	@cp external/userland/build/reboot $(BUILD_DIR)/testfs/bin/reboot 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) reboot not built"
	@cp external/userland/build/signal_test $(BUILD_DIR)/testfs/bin/signal_test 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) signal_test not built"
	@cp external/userland/build/pipe_test $(BUILD_DIR)/testfs/bin/pipe_test 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) pipe_test not built"
	@cp external/userland/build/pipe_simple_test $(BUILD_DIR)/testfs/bin/pipe_simple_test 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) pipe_simple_test not built"
	@cp external/userland/build/mutex_test $(BUILD_DIR)/testfs/bin/mutex_test 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) mutex_test not built"
	@cp external/userland/build/condvar_test $(BUILD_DIR)/testfs/bin/condvar_test 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) condvar_test not built"
	@cp external/userland/build/rwlock_test $(BUILD_DIR)/testfs/bin/rwlock_test 2>/dev/null || echo "  $(YELLOW)Warning:$(RESET) rwlock_test not built"
